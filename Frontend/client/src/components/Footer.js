      ...
      <div className="container text-white" style={{ marginTop: "5%" }}>
        <div className="row">
          ...
          <div className="col-12">
            <div className="row">
              <div className="col-12 col-md-6" style={{ marginTop: "1.5%" }}>
                NGO ALLY is a platform that bridges the gap between NGOs and
                volunteers. NGOs can create and share campaigns, while
                volunteers can browse and apply for campaigns that align with
          ...
          <div style={{ marginTop: "1.5%", marginBottom: "1%" }}>
            <span class="text-light">&copy;2024 NGO Ally</span>
          </div>
        </div>
      </div>
    </div>
